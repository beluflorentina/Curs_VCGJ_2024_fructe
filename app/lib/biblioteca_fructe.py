...
def culoare_smochina():
    return "The date fruit has a colour ranging from dark brown to bright red or yellow, depending on the variety"

def descriere_smochina():
    return "The date fruit is delicious, and a fun fact is that ancient cultures, such as Sumerians and Egyptians, used date honey in the production of beer, to help with the fermentation process and also for a pump of sweetness!"
