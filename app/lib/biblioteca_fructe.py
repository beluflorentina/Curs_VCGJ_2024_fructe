def culoare_acai():
    return "The acai fruit is renowned for its deep, rich purple color, reminiscent of a luscious dark berry. Its hue is a striking blend of deep purples with hints of red and violet, creating a mesmerizing visual appeal. This vibrant color not only tantalizes the eyes but also signifies the potent antioxidants and nutrients packed within the fruit, making it both visually stunning and nutritionally beneficial."
...
def culoare_curmala():
    return "Culoarea unei curmale depinde de tipul acesteia. \n De exemplu, curmalele medjoon au culoarea ambrei spre maro-rosiatic, in timp ce curmalele piarom au culoarea mai intunecata."
    
def descriere_curmala():
    return "Curmalele sunt fructele unui tip de palmier originar din Orientul Mijlociu. Acesta este cultivat in nenumarate locuri din lume, din Africa de Nord pana in Asia de Sud.\n Curmalele contin cantitati mari de nutrienti, minerale si vitamine, astfel ca ofera o serie de avantaje si beneficii organismului uman."
