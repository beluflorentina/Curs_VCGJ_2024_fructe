...
Aplicatia este simpla, afiseaza informatii despre descrierea si culoarea fructului cu ajutoru functiilor culoare_duran() si descriere_duran().
 ...
 * rute in aplicatia WEB pentru:
   * fruct:     '/duran' - URL: 'http://127.0.0.1:5000/duran',
   * culoare:   '/culoare' -                        .../duran/culoare
   * descriere: '/descriere' -                      .../duran/descriere
...
```text 
   ...
   git checkout devel_Hrisotimos_Andrei
   ...
   docker login
   docker tag imagine-aplicatie hrisotimosandrei/imagine_aplicatie:latest
   docker push hrisotimosandrei/imagine_aplicatie:latest
   ...
   git push origin devel_Hrisotimos_Andrei
